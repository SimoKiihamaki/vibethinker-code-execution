...
const synthesizeFindingsSchema = z.object({ findings: z.array(z.object({ type: z.string().optional(), severity: z.enum(['low', 'medium', 'high', 'critical']).optional(), detail: z.string().optional(), message: z.string().optional() }).passthrough()), topic: z.string().describe('Topic or area of focus'), depth: z.enum(['overview', 'detailed', 'comprehensive']).default("detailed"), includeRecommendations: z.boolean().default(true) });
